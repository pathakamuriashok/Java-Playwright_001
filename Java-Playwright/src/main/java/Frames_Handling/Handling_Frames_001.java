...
public class Handling_Frames_001 {
	...
	@Test(priority = 2)
	public void Frames_001() throws InterruptedException
	{
		page.frameLocator("xpath=//frame[@src='frame_1.html']").locator("//input[@type='text']//ancestor::div[1]/input[1]").fill("ASHOK");
	    Thread.sleep(5000); 
	}
